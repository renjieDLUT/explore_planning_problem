...
#
# class Net(nn.Module):
#     def __init__(self, intput_num: int, drop_prob: float):
#         super(Net, self).__init__()
#         self.Linears = nn.Sequential(nn.Dropout(drop_prob), nn.Linear(intput_num, 1, bias=False), nn.ReLU())
#
#     def forward(self, x):
...
#
# num_neuron = 1000
# net = Net(num_neuron, 0.5)
# net.Linears[1].weight.data.fill_(1.)
#
# x = torch.ones(num_neuron)
# x.unsqueeze_(dim=0)
#
# net.train()
# y_hat = net(x)
